...
export default function EditableField(props) {
    return (
        <InputGroup className='my-1 flaex-nowrap'>
            {
                props.cellData.leading  &&
                <InputGroup.Text className='bg-light fw-bold border-0 text-secondary px-2'>
                    <span className='border border-2 border-secondary rounded-circle d-flex align-item-center justify-content-center small' style={{ width: "20px" }}>
                        {props.cellData.leading}
                    </span>
                </InputGroup.Text>
            }

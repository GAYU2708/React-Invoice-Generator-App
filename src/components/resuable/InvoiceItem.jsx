...
export default function InvoiceItem(props) {
  ...
  var ItemTable = props.items.map((item) => (<ItemRow onItemizedItemEdit={props.onItemizedItemEdit} 
                                                   ...
                                                   key={item.id} currency={props.currency} />
                                                   ));
...
const onDelEvent =()=>{
  ...
  return(
    <tr>
      <td style={{width:'100%'}}>
        <EditableField onItemizedItemEdit={props.onItemizedItemEdit}
          cellData={{
            type: 'text',
            name: 'name',
      ...
      <td className='text-center' style={{minWidth:"50px"}}>
            <BiTrash onClick={onDelEvent} style={{height:"33px",width:"33px",padding:"7.5px"}}
